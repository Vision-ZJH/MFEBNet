...
from models.SwinUMamba import VSSMEncoder
from timm.models.layers import DropPath, to_2tuple, trunc_normal_
import timm
import re

from models.BAD import BAD
...
class MFEBNet(nn.Module):
    def __init__(self,
        ...
        self.decoder = Decoder((48, 96, 192, 384), decode_channels, dropout, window_size, num_classes)
    ...
    def forward(self, x):
        ...
        vss_outs[3] = self.bad(vss_outs[3])

        vss_outs[0], vss_outs[1], vss_outs[2] = self.mdfe(vss_outs[0], vss_outs[1], vss_outs[2])

        x = self.decoder(vss_outs[0], vss_outs[1], vss_outs[2], vss_outs[3], h, w)
